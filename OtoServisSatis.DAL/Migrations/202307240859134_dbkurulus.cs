        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SatisDurumu = c.Boolean(nullable: false),
                        AracBilgileri = c.String(),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ServisGelisTarihi = c.DateTime(nullable: false),
                        AracSorun = c.String(),
                        ServisUcreti = c.Decimal(nullable: false, precision: 18, scale: 2),
                        ServistenCikisTarihi = c.DateTime(nullable: false),
                        Yapılanİslemler = c.String(),
                        GarantiVarmi = c.Boolean(nullable: false),
                        AracPlaka = c.String(),
                        Marka = c.String(),
                        Model = c.String(),
                        KasaTipi = c.String(),
